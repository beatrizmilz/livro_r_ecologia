...
# Podemos combinar os dois gráficos para comparar as duas medidas de distância, uma somente com dados categóricos (Gower) e uma com dados categóricos e ordinais (Gower)
...
#!!!! Inserir uma Figura com o desenho esquemático de cada componente !!!!!!!!
